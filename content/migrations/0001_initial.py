    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('True', 'True'), ('False', 'False')], default='Yeni', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('menu', 'menu'), ('ilan', 'ilan'), ('duyuru', 'duyuru'), ('etkinlik', 'etkinlik')], max_length=10)),
